  ...
  return (
    ...
    <div className='bg-[url("/assets/images/wepp/hero-bg-image.webp")] pt-[100px] bg-cover bg-center bg-no-repeat px-4'>
      ...
      <div className="container mx-auto max-w-[1140px] py-[51px] max-sm:py-10 flex justify-center items-center flex-col">
        ...
        <p className="max-w-[637px] mx-auto text-center text-4xl leading-[150%] font-semibold tracking-[2px] text-white mt-2.5 max-md:text-3xl max-sm:text-xl">
          FOR A WHEALTHIER LIFESTYLE. ANYTIME, ANYWHERE
        </p>
        <button className="font-extrabold text-xl leading-[24px] tracking-[2px] py-4 px-7 mt-[44px] bg-custom-gradient text-white rounded-lg">Get Started</button>
      </div>
    </div>
